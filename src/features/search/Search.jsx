                            ...
                            <>
                                ...
                                <div className="row row-cols-1 g-3">
                                    ...
                                    <div className="col">
                                        ...
                                        <select className="form-select" name="rarity" aria-label="Rarity" disabled={setsStatus === "loading"}>
                                    ...
                                    <div className="col">
                                        ...
                                        <select className="form-select" name="sortBy" aria-label="SortBy" disabled={setsStatus === "loading"}>
