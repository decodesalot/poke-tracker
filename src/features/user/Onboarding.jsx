									...
									{step === 1 && (
										<div className="text-center">
											...
											<p className="text-muted mb-5">
												The ultimate Pokemon card collection manager. Track your cards, connect with
												friends, and build your dream collection.
											</p>
													...
													<div className="d-flex gap-3 align-items-start">
														...
														<div>
															...
															<small className="text-muted">
																Browse thousands of Pokemon cards from all sets
															</small>
														</div>
													</div>
												</div>
												<div className="col-12">
													<div className="d-flex gap-3 align-items-start">
														...
														<div>
															...
															<small className="text-muted">
																Track quantities, values, and organize your collection
															</small>
														</div>
													</div>
												</div>
												<div className="col-12">
													<div className="d-flex gap-3 align-items-start">
														...
														<div>
															...
															<small className="text-muted">
																View friends' collections and discover new cards
															</small>
														</div>
													</div>
												</div>
										...
										<div className="animate-fade-in">
											<div className="text-center mb-4">
												...
												<p className="text-muted">
													Configure your data preferences for real-time analytics.
												</p>
											</div>
											...
											<p className="text-muted small mt-2 mb-3">
												<i className="bi bi-info-circle me-1"></i>This will be the name displayed on
												your dashboard.
											</p>
